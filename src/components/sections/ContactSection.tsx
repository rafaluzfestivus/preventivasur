            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-1/2">
                        <span className="text-blue-400 font-bold tracking-wider text-sm uppercase mb-2 block">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <div className="flex flex-col">
                                            <span className="text-xs text-blue-400 font-bold uppercase tracking-wider">Madrid</span>
                                            <div className="flex flex-col gap-1">
                                        ...
                                        <div className="flex flex-col mt-2">
                                            <span className="text-xs text-blue-400 font-bold uppercase tracking-wider">Andalucía</span>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all" placeholder="600 000 000" />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea rows={4} className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all resize-none" placeholder="Cuéntanos más sobre lo que necesitas..."></textarea>
                                </div>

                                <button type="button" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl mt-2">

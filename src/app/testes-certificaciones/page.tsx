                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-300 leading-relaxed">
                            Na Preventiva Centro, a segurança não é uma promessa, é uma certificação.
                            Utilizamos materiais de última geração desenhados para resistir às condições climáticas de Madrid.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="container mx-auto px-4 md:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
                        ...
                        <div className="bg-gray-100 rounded-3xl aspect-video relative overflow-hidden shadow-inner">
                            ...
                            {/* In a real project, we would use a macro photo of the knot here */}
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4 md:px-8 text-center max-w-4xl">
                    ...
                    <p className="text-xl text-slate-600 leading-relaxed mb-12">
                        ...
                        diseñados para anclarse firmemente en ladrillo, hormigón o estructuras metálicas, sin riesgo de desprendimiento.
                    </p>
                </div>
            </section>

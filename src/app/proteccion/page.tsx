                ...
                <div className="container mx-auto px-4 md:px-8 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-300 leading-relaxed mb-12">
                            Soluciones especializadas en redes de seguridad para niños, mascotas y control de aves.
                            Resistencia, estética y tranquilidad en una sola instalación.
                        </p>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                                Protege a los que más quieres con la solución más discreta y resistente del mercado.
                                Seguridad certificada para ventanas, balcones y escaleras sin que tu casa parezca una "prisión".
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                                ...
                                <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                    <h4 className="font-bold text-slate-900 mb-2">Adaptabilidad Total</h4>
                                    <p className="text-sm text-slate-600">Para escaleras, balcones de cristal o ventanas oscilobatientes.</p>
                                </div>
                            </div>
                        ...
                        <div className="lg:w-1/2">
                            <div className="rounded-[2.5rem] overflow-hidden shadow-2xl aspect-square relative">
                                ...
                                <div className="absolute bottom-10 left-10 right-10 bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-white/20">
                                    ...
                                    <span className="text-yellow-600 text-sm font-bold uppercase tracking-widest">Premium Invisible Mesh</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-4 md:px-8">
                    <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                                Evita el temido <span className="font-bold text-slate-900">"Síndrome del Paracaidista"</span>.
                                Instalamos redes ultra-resistentes, anti-mordeduras y diseñadas para que tus felinos
                                disfruten de la brisa con total seguridad.
                            </p>
                            ...
                            <ul className="space-y-4 mb-10">
                                <li className="flex items-start gap-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900">Anti-Mordeduras</h4>
                                ...
                                <li className="flex items-start gap-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
                                    <CheckCircle className="text-green-500 w-6 h-6 mt-1" />
                                    <div>
                                        <h4 className="font-bold text-slate-900">Mínimo Impacto Visual</h4>
                                        <p className="text-sm text-slate-600">Redes de bajo grosor que pasan desapercibidas desde el exterior de la fachada.</p>
                                    </div>
                                </li>
                            </ul>
                ...
                <div className="container mx-auto px-4 md:px-8">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                                Em Madrid, o problema das pombas é quase uma praga urbana, especialmente em zonas como o Centro, Chamberí e Salamanca.

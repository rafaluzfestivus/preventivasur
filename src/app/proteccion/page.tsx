...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://preventivacentro.es/proteccion",
    },
    openGraph: {
        url: "https://preventivacentro.es/proteccion",
        title: "Redes de Protección en Madrid | Niños, Gatos y Aves",
        description: "Protección integral para tu hogar en Madrid. Mallas certificadas para seguridad infantil, protección de gatos y control de aves.",
